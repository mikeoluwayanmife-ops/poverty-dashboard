...
if page == "Home":
    ...
    | **Poverty Maps** | Interactive maps showing poverty distribution across Nigeria |
...
# ============================================
    ...
    if state_data['Conflict_Level'] in ['High', 'Very High']:
        recommendations.append("High conflict level. Prioritize peace-building and community reconciliation.")
...
# ============================================
    ...
    if feature_importance is not None:
        ...
        st.warning("Feature importance data not found. Please run the EBM model first.")
